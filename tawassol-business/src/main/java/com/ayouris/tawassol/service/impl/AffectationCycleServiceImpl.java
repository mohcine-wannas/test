...
import com.ayouris.tawassol.common.model.entity.QAffectationCycle;
...
public class AffectationCycleServiceImpl extends GenericServiceImpl2<AffectationCycle,Long,AffectationCycleBean> implements AffectationCycleService {
	...
	private AffectationCycle getAffectationCycleBySchoolAndCycleAndAnneeScolaire(School school, Cycle cycle, AnneeScolaire anneeScolaire) {
	...
	private void generateClasse(AffectationCycle oldAffectationCycle, AffectationCycleBean affectationCycleBean) {
		...
		oldEntityLoop: for (AffectationNiveau oldAffectationNiveau : oldAffectationCycle.getAffectationNiveaux()) {
