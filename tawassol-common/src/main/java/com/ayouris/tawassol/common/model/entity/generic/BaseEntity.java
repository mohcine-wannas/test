...
import com.ayouris.tawassol.common.repository.util.PersistenceUtils;
...
public abstract class BaseEntity implements Serializable {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "gwic_seq_generator")
    @SequenceGenerator(name = "gwic_seq_generator", initialValue = 1, allocationSize = 100, sequenceName = "tawassol.gwic_seq")
    public Long getId() {
        return id;
    }
