...
@Setter
@Getter
public class MessageModelProfBean implements Serializable {

    private static final long serialVersionUID = -5029569008726313519L;

    @SuppressWarnings("serial")
    public static final Type LIST_BEAN_TYPE = new TypeToken<ArrayList<MessageModelProfBean>>() {
    }
            .getType();
    ...
    private CategorieProfBean categorie;
