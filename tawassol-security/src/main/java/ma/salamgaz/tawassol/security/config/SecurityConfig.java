package ma.salamgaz.tawassol.security.config;
...
import ma.salamgaz.tawassol.security.filter.Http401UnauthorizedEntryPoint;
import ma.salamgaz.tawassol.security.filter.TokenAuthenticationFilter;
...
@ComponentScan(basePackages = {"ma.salamgaz.tawassol", "org.springframework.security"})
@Order(1)
