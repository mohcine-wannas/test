...
@Transactional
@Service("userService")
//@EnableJpaRepositories(basePackages = "ma.salamgaz.tawassol.security.repository", entityManagerFactoryRef = "ma.salamgaz.tawassol.common.repository.impl.CommonRepositoryFactoryBean")
