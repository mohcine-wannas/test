...
import ma.salamgaz.gwic.messaging.sender.MailSender;
import ma.salamgaz.gwic.reporting.helper.BuildReport;
import ma.salamgaz.gwic.service.ClubService;
...
public class ClubController extends BaseController {
    ...
    public ResponseEntity<Void> sendMail() throws Exception {
        ...
        mailSender.sendMail("user@gwic.ma", "admin@salamgaz.ma", null, null, "Test Mail", "test-mail.ftl", params);
