...
import ma.salamgaz.gwic.common.util.EncodageConstants;
import ma.salamgaz.gwic.common.util.UnicodeStringUtils;

public class RequestUtil {

    public static List<String> resurceEndPoints = Arrays.asList("gwic/service", "gwic/common", "gwic/admin");
