package ma.salamgaz.gwic.common.constant;
...
public class ApplicationConstants {
    ...
    // database
    //public static final String EDM_REF_SEQUENCE = "gwic.alfresco_reference_seq";
    public static final int SEARCH_RESULT_LIMIT = 10;   
    public static final String FUNCTIONAL_REF_SEQUENCE = "gwic.functional_reference_seq";
    ...
    // Security
    public static final String VALIDATOR_GWIC_NAME = "AGWIC";
