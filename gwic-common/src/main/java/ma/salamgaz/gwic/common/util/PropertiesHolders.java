...
import ma.salamgaz.gwic.common.enums.Env;
...
public Boolean getBaselineOnMigrate() {
  ...
  //-------- JPA Configuration -------------------------------
   ...
   //-----------------------------------------------------
    @Value("${gwic.deployement.env}")
    private String envDeployement;

    @Value("${gwic.default.lang}")
    private String defaultLang;

    @Value("${gwic.mail.adress.sender}")
    protected String fromMail;

    @Value("${gwic.mail.adress.recepient}")
    protected String defaultRecepientMail;

    @Value("${gwic.application.dns}")
    protected String gwicDns;

    @Value("${gwic.mail.adress.copy}")
