...
import ma.salamgaz.gwic.common.repository.util.PersistenceUtils;
...
public abstract class BaseEntity implements Serializable {
    ...
    @SequenceGenerator(name = "gwic_seq_generator", initialValue = 1, allocationSize = 100, sequenceName = "gwic.gwic_seq")
    public Long getId() {
        return id;
    }
